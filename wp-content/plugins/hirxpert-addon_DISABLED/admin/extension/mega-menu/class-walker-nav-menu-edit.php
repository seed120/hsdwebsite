 ...
 * @see Walker_Nav_Menu
 */
class Hirxpert_Walker_Nav_Menu_Edit extends Walker_Nav_Menu {
	/**
	...
	public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
		...
		<li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode( ' ', $classes ); ?>">
			...
			<div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
				...
				<?php 
				/* Custom code */ 
				$hirxpert_advance_menu = true;
				if( $hirxpert_advance_menu ):
				?>
				<p class="field-hirxpert-custom-settings description-wide">
					<label for="edit-menu-item-custom-settings-<?php echo $item_id; ?>">
						<span><?php esc_html_e( 'Hirxpert Custom', 'hirxpert-addon' ); ?></span>
						<?php
						printf(
							'<a href="#hirxpert-general-settings-form" class="item-general-settings hirxpert-general-settings-form" data-menu="%1$s" data-depth="%2$s">%3$s</a>',
							esc_attr( $item_id ),
							esc_attr( $depth ),
							esc_html__( 'Settings', 'hirxpert-addon' )
						);
						$hirxpert_menu = $item->hirxpertmenu ? $item->hirxpertmenu : json_encode( array( "icon" => "", "megamenu" => "", "megamenucol" => "", "megamenuwidget" => '' ));
						?>
						<textarea id="edit-menu-item-hirxpert-<?php echo $item_id; ?>" class="widefat edit-menu-item-hirxpert screen-reader-text" rows="3" cols="20" name="menu-item-hirxpertmenu[<?php echo $item_id; ?>]"><?php echo esc_html( $hirxpert_menu ); // $item->hirxpertmenu textarea_escaped ?></textarea>
					</label>
				</p>
				<?php endif; 
				/* Custom code end */ 
