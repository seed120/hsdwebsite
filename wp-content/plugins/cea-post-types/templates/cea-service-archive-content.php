...
$infinite = $t->ceaGetThemeOpt( 'service-infinite-scroll' ) ? 'true' : 'false';
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class( 'post cea-service' . $article_class ); ?>>
						<div class="service-archive">
							...
							<div class="service-archive-title">
								<?php 
									$custom_url = get_post_meta( get_the_ID(), 'cea_service_custom_url', true );
									$target = get_post_meta( get_the_ID(), 'cea_service_custom_url_target', true );
