...
class CEA_Elementor_Posts_Widget extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( "Posts", 'classic-elementor-addons-pro' );
	}
     ...
     * Get Keywords
     *
     * Retrieve the list of keywords that used to search for Cea Posts widget
     * 
     * @access public
     * 
    ...
    public function get_keywords(): array {
        return [ 'zozo', 'cea', 'posts', 'blog', 'classic' ];
    }
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				...
				"description"	=> esc_html__( "Posts query options.", 'classic-elementor-addons-pro' ),
			]
		);
		...
		$this->add_control(
			'include_author',
			[
				'label' 		=> esc_html__( 'Author', 'classic-elementor-addons-pro' ),
		...
		$this->add_control(
			'include_cats',
			[
				'label' 		=> esc_html__( 'Categories', 'classic-elementor-addons-pro' ),
		...
		$this->add_control(
			'exclude_cats',
			[
				'label' 		=> esc_html__( 'Exclude Categories', 'classic-elementor-addons-pro' ),
		...
		$this->add_control(
			'include_tags',
			[
				'label' 		=> esc_html__( 'Tags', 'classic-elementor-addons-pro' ),
		...
		$this->add_control(
			'include_posts',
			[
				'label' 		=> esc_html__( 'Include', 'classic-elementor-addons-pro' ),
				'type' 			=> Controls_Manager::SELECT2,
				'multiple'	 	=> true,
				'label_block'	=> true,
				'options' 		=> $post_titles,
		...
		$this->add_control(
			'exclude_posts',
			[
				'label' 		=> esc_html__( 'Exclude', 'classic-elementor-addons-pro' ),
				'type' 			=> Controls_Manager::SELECT2,
				'multiple'	 	=> true,
				'label_block'	=> true,
				'options' 		=> $post_titles,
		...
		$this->add_control(
			'orderby',
			[
				'label' 		=> esc_html__( 'Order By', 'classic-elementor-addons-pro' ),
		...
		$this->add_control(
			'order',
			[
				'label' 		=> esc_html__( 'Order', 'classic-elementor-addons-pro' ),
				'type' 			=> Controls_Manager::SELECT,
				'label_block'	=> true,
				'options' => [
                    'asc' => 'Ascending',
		...
		$this->add_control(
			...
			[
				"type"			=> Controls_Manager::SELECT,
				"label"			=> esc_html__( "Columns on Desktop", 'classic-elementor-addons-pro' ),
			...
			[
				"type"			=> Controls_Manager::SELECT,
				"label"			=> esc_html__( "Columns on Tab", "classic-elementor-addons-pro" ),
				"description"	=> esc_html__( "This is option for blog columns on Tablets.", "classic-elementor-addons-pro" ),
				"default"		=> "6",
				"options"		=> [
					"3"			=> esc_html__( "4 Columns", "classic-elementor-addons-pro" ),
					"4"			=> esc_html__( "3 Columns", "classic-elementor-addons-pro" ),
		...
		$this->add_control(
			...
			[
				"type"			=> Controls_Manager::SELECT,
				"label"			=> esc_html__( "Columns on Mobile", "classic-elementor-addons-pro" ),
				"description"	=> esc_html__( "This is option for blog columns on Mobile.", "classic-elementor-addons-pro" ),
				"default"		=> "12",
				"options"		=> [
					"3"			=> esc_html__( "4 Columns", "classic-elementor-addons-pro" ),
					"4"			=> esc_html__( "3 Columns", "classic-elementor-addons-pro" ),
		...
		$this->add_control(
			"blog_masonry",
			[
				"label" 		=> esc_html__( "Post Masonry", 'classic-elementor-addons-pro' ),
				"description"	=> esc_html__( "This is option for blog masonry or normal.", 'classic-elementor-addons-pro' ),
		...
		$this->add_control(
			...
			[
				"type"			=> Controls_Manager::TEXT,
				"label"			=> esc_html__( "Post Masonry Gutter", 'classic-elementor-addons-pro' ),
				"description"	=> esc_html__( "Here you can mention blog masonry gutter size. Example 30", 'classic-elementor-addons-pro' ),
				"default" 		=> "10",
				"condition" 	=> [
					"blog_masonry" 		=> "yes",
					"blog_layout!" 		=> "list"
		...
		$this->add_control(
			"lazy_load",
			[
				"label"			=> esc_html__( "Lazy Load", 'classic-elementor-addons-pro' ),
				"description"	=> esc_html__( "Enabel lazy load option for load isotope grids lazy with animation.", 'classic-elementor-addons-pro' ),
				"type" 			=> Controls_Manager::SWITCHER,
				"default" 		=> "no",
				"condition" 	=> [
					"blog_masonry" => "yes",
		...
		$this->add_control(
			"isotope_filter",
			[
				"label"			=> esc_html__( "Isotope Filter", 'classic-elementor-addons-pro' ),
				"description"	=> esc_html__( "Enabel to show blog filter by category.", 'classic-elementor-addons-pro' ),
				"type" 			=> Controls_Manager::SWITCHER,
				"default" 		=> "no",
				"condition" 	=> [
					"blog_masonry" => "yes",
		...
		$this->add_control(
			...
			[
				"type"			=> Controls_Manager::TEXT,
				"label"			=> esc_html__( "Filter All Text", 'classic-elementor-addons-pro' ),
				"description"	=> esc_html__( "Here you can mention blog's first filter text.", 'classic-elementor-addons-pro' ),
				"default" 		=> esc_html__( "All", 'classic-elementor-addons-pro' ),
				"condition" 	=> [
					"isotope_filter" 		=> "yes",
					"blog_layout!" 		=> "list"
				]
		...
		$this->add_control(
			"masonry_layout",
			[
				"label"			=> esc_html__( "Masonry Layout", 'classic-elementor-addons-pro' ),
				"type"			=> Controls_Manager::SELECT,
				"default"		=> "masonry",
				"options"		=> [
					"masonry"		=> esc_html__( "Masonry", 'classic-elementor-addons-pro' ),
					"fitRows"		=> esc_html__( "Fit Rows", 'classic-elementor-addons-pro' )
				],
				"condition" 	=> [
					"blog_masonry" => "yes",
					"blog_layout!" 		=> "list"
		...
		$this->add_control(
			"blog_infinite",
			[
				"label"			=> esc_html__( "Post Masonry Infinite", 'classic-elementor-addons-pro' ),
				"description"	=> esc_html__( "This is option for blog masonry infinite scroll.", 'classic-elementor-addons-pro' ),
				"type" 			=> Controls_Manager::SWITCHER,
				"default" 		=> "no",
				"condition" 	=> [
					"blog_masonry" => "yes",
		...
		$this->add_control(
			...
			[
				"type"			=> Controls_Manager::TEXT,
				"label"			=> esc_html__( "Infinite Loading Message", 'classic-elementor-addons-pro' ),
				"description"	=> esc_html__( "Here you can mention infinite loading post message.", 'classic-elementor-addons-pro' ),
				"default" 		=> esc_html__( "Loading posts..", 'classic-elementor-addons-pro' ),
				"condition" 	=> [
					"blog_infinite" 		=> "yes",
					"blog_layout!" 		=> "list"
				]
		...
		$this->add_control(
			...
			[
				"type"			=> Controls_Manager::TEXT,
				"label"			=> esc_html__( "Infinite Ending Message", 'classic-elementor-addons-pro' ),
				"description"	=> esc_html__( "Here you can mention infinite loading ending message.", 'classic-elementor-addons-pro' ),
				"default" 		=> esc_html__( "No more post.", 'classic-elementor-addons-pro' ),
				"condition" 	=> [
					"blog_infinite" 		=> "yes",
					"blog_layout!" 		=> "list"
				]
		...
		$this->add_control(
			'loading_img',
			[
				'label' => esc_html__( 'Infinite Loader Image URL', 'classic-elementor-addons-pro' ),
				"description"	=> esc_html__( "Here you can choose infinite loader image.", 'classic-elementor-addons-pro' ),
		...
		$this->add_control(
			"blog_pagination",
			[
				"label" 		=> esc_html__( "Post Pagination", 'classic-elementor-addons-pro' ),
				"type" 			=> Controls_Manager::SWITCHER,
				"default" 		=> "no",
				"condition" 	=> [
					"blog_masonry!" 		=> "yes"
		...
		$this->start_controls_section(
			...
			[
				...
				"tab"			=> Controls_Manager::TAB_CONTENT,
				"description"	=> esc_html__( "Posts slide options here available.", 'classic-elementor-addons-pro' ),
				"condition" 	=> [
					"extent_opt!" => "yes"
				]
			]
		...
		$this->start_controls_section(
			"img_zoom_section",
			[
				"label"			=> esc_html__( "Image Accordion", "classic-elementor-addons-pro" ),
				"tab"			=> Controls_Manager::TAB_CONTENT,
				"condition"		=> [
					"slide_opt!"	=> "yes"
				]
		...
		$this->add_control(
			"extent_opt",
			[
				"label" 		=> esc_html__( "Image Accordion Option", "classic-elementor-addons-pro" ),
				"description"	=> esc_html__( "This is option for blog image accordion option.", "classic-elementor-addons-pro" ),
				"type" 			=> Controls_Manager::SWITCHER,
				"default" 		=> "no"
			]
		);
		$this->add_control(
			"extent_ppp",
			[
				"label"			=> esc_html__( "Enter the Number of Images", "classic-elementor-addons-pro" ),
				"description"   => esc_html__( "This options determines how many image should be displayed", "classic-elementor-addons-pro" ),
				"type"			=> Controls_Manager::TEXT,
				"default"		=> "4",
				"condition"     => [
					"extent_opt"	=> "yes"
		...
		$this->add_control(
            'accordion_style',
            [
                'label'         => esc_html__('Layout Style', 'classic-elementor-addons-pro'),
                'type'          => Controls_Manager::SELECT,
                'options'       => [
                    'horizontal'    => esc_html__('Horizontal', 'classic-elementor-addons-pro'),
                    'vertical'      => esc_html__('Vertical', 'classic-elementor-addons-pro'),
                ],
                'default'       => 'horizontal',
				"condition"     => [
					"extent_opt"	=> "yes"
		...
		$this->add_control(
			'accordion_break_pts', 
			[
				'label'         => esc_html__('Breakpoint', 'classic-elementor-addons-pro'),
				'description'   => esc_html__( 'At which point the Horizontal Accordion should change into vertical for responsive', 'classic-elementor-addons-pro' ),
                'type'          => Controls_Manager::SELECT,
                'options'       => [
                    'none'    => esc_html__('None', 'classic-elementor-addons-pro'),
                    'mobile'      => esc_html__('Mobile Portrait (> 768px)', 'classic-elementor-addons-pro'),
		...
		$this->start_controls_section(
			'section_hr_effect',
			[
				'label' => __( 'Effects', 'classic-elementor-addons-pro' ),
		...
		$this->add_control(
            'enable_mouse_hover',
            [
                'label'   => __('Enable Mouse Hover?', 'classic-elementor-addons-pro'),
		...
		$this->add_control(
            ...
            [
                'label'       => __('Choose Text to Show on Hover', 'classic-elementor-addons-pro'),
                'type'        => \Elementor\Controls_Manager::SELECT2,
                'multiple'    => true,
                'label_block' => true,
                'default'     => ['title'],
                'options'     => [
                    'title'    => __('Title', 'classic-elementor-addons-pro'),
                    'category' => __('Category', 'classic-elementor-addons-pro'),
                ],
                'condition'   => [
        ...
        $this->add_control(
			'mouse_hvr_hide',
			[
				'label' 	=> __( 'Cursor Visibility', 'classic-elementor-addons-pro' ),
				'type' 		=> \Elementor\Controls_Manager::SELECT,
				'options'	=> [
					'auto'	=> 	__( 'Visible', 'classic-elementor-addons-pro' ),
					'none'	=>  __( 'Hide', 'classic-elementor-addons-pro' ),
				],
				'condition'   => [
                    'enable_mouse_hover' => 'yes',
                ],
		...
		$this->add_control(
			'more_link',
			[
				'label' => esc_html__( 'Read More', 'classic-elementor-addons-pro' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			'section_style_post',
			[
				'label' => esc_html__( 'Post Grid', 'classic-elementor-addons-pro' ),
		...
		$this->start_controls_section(
			'section_style_post_category',
			[
				'label' => __( 'Category', 'classic-elementor-addons-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			"category_text_post_trans",
			[
				"label"			=> esc_html__( "Category Transform", "classic-elementor-addons-pro" ),
				"type"			=> Controls_Manager::SELECT,
				"description"	=> esc_html__( "Set text-transform property.", "classic-elementor-addons-pro" ),
				"default"		=> "none",
				"options"		=> [
					"none"			=> esc_html__( "Default", "classic-elementor-addons-pro" ),
					"capitalize"	=> esc_html__( "Capitalized", "classic-elementor-addons-pro" ),
		...
		$this->start_controls_tabs( 'tabs_post_category_style' );
		$this->start_controls_tab(
			'tab_post_category_normal',
			[
				'label' => esc_html__( 'Normal', 'classic-elementor-addons-pro' ),
			]
		);
		...
		$this->add_control(
			'post_links',
			[
				'label' => esc_html__( 'Default Post Links', 'classic-elementor-addons-pro' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'post_tmetalinks',
			[
				'label' => esc_html__( 'Top Meta Links', 'classic-elementor-addons-pro' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'post_bmetalinks',
			[
				'label' => esc_html__( 'Bottom Meta Links', 'classic-elementor-addons-pro' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'post_ometalinks',
			[
				'label' => esc_html__( 'Overlay Links', 'classic-elementor-addons-pro' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			'section_style_meta',
			[
				'label' => esc_html__( 'Meta', 'classic-elementor-addons-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);	
		$this->add_control(
			'top_meta_style',
			[
				'label' => esc_html__( 'Top Meta', 'classic-elementor-addons-pro' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'bottom_meta_style',
			[
				'label' => esc_html__( 'Bottom Meta', 'classic-elementor-addons-pro' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			"img_accordion_style",
			[
				"label"			=> esc_html__( "Image Accordion Styles", "classic-elementor-addons-pro" ),
				"tab"			=> Controls_Manager::TAB_STYLE,
				"condition"		=> [
					"extent_opt"	=> "yes"
				]
		...
		$this->add_responsive_control(
			'img_acc_gap',
			[
				"label" 		=> esc_html__( "Accordion Gap", "classic-elementor-addons-pro" ),
				"type"			=> Controls_Manager::SLIDER,
		...
		$this->add_responsive_control(
			...
			[
				"type"			=> Controls_Manager::TEXT,
				"label"			=> esc_html__( "Image Accordion Height", "classic-elementor-addons-pro" ),
				"description"	=> esc_html__( "This is option for post image accordion height.", "classic-elementor-addons-pro" ),
				"default" 		=> "670",
				"selectors"	    => [ 
		...
		$this->add_responsive_control(
			...
			[
				"type"			=> Controls_Manager::TEXT,
				"label"			=> esc_html__( "Image Accordion Width", "classic-elementor-addons-pro" ),
				"description"	=> esc_html__( "This is option for post image accordion width.", "classic-elementor-addons-pro" ),
				"default" 		=> "670",
				"selectors"	    => [
					'{{WRAPPER}} .cea-image-accordion-vertical .image-accordion-item > .post-thumb > a > img' => 'width: {{VALUE}}px;',
					'{{WRAPPER}} .cea-image-accordion-horizontal .image-accordion-item > .post-thumb img' => 'height: {{VALUE}}px;',
		...
		$this->add_responsive_control(
			...
			[
				...
				"description"   => esc_html__( "Adjust the post image width in normal state (in percentage).", "classic-elementor-addons-pro" ),
				"size_units"	=> [ 'px', '%', 'rem', 'em' ],
				"default"       => [
					"size" => 300,
					"unit" => 'px',
		...
		$this->add_responsive_control(
			...
			[
				"type"          => Controls_Manager::SLIDER,
				"label"         => esc_html__( "Image Height", "classic-elementor-addons-pro" ),
				"description"   => esc_html__( "Adjust the post image height in normal state (in percentage).", "classic-elementor-addons-pro" ),
				"size_units"	=> [ 'px', '%', 'rem', 'em' ],
				"default"       => [
					"size" => 200,
					"unit" => 'px',
		...
		$this->add_responsive_control(
			...
			[
				"type"          => Controls_Manager::SLIDER,
				"label"         => esc_html__( "Image Width ", "classic-elementor-addons-pro" ),
				"description"   => esc_html__( "Adjust the post image width in hover state (in percentage).", "classic-elementor-addons-pro" ),
				"size_units"	=> [ 'px', '%', 'rem', 'em' ],
				"default"       => [
					"size" => 600,
					"unit" => 'px',
		...
		$this->add_responsive_control(
			...
			[
				"type"          => Controls_Manager::SLIDER,
				"label"         => esc_html__( "Image Height ", "classic-elementor-addons-pro" ),
				"description"   => esc_html__( "Adjust the post image height in hover state (in percentage).", "classic-elementor-addons-pro" ),
				"size_units"	=> [ 'px', '%', 'rem', 'em' ],
				"default"       => [
					"size" => 400,
					"unit" => 'px',
	...
	public function render_content() {
		...
		if( !$blog_masonry && !$slide_opt && !$extent_opt ){
		...
		<div class="elementor-widget-container blog-wrapper<?php echo esc_attr( $class_names ); ?>" <?php echo ( $extent_opt ) ? 'data-wrap="'. $accordion_break_pts .'"' : ''; ?>>
	...
	protected function render() {
		...
		$filter_all = isset( $filter_all ) && $filter_all != '' ? $filter_all : esc_html__( "All", 'classic-elementor-addons-pro' );
		...
		$cols_tab = isset( $blog_cols_tab ) ? $blog_cols_tab : 12;
		$col_mbl = isset( $blog_cols_mbl ) ? $blog_cols_mbl : 12;
		...
		if ( $query->have_posts() ) {
			...
			if( $slide_opt ) {
				...
				$loading_msg = isset( $loading_msg ) && $loading_msg != '' ? $loading_msg : esc_html__( 'Loading..', 'classic-elementor-addons-pro' );
				$loading_end = isset( $loading_end ) && $loading_end != '' ? $loading_end : esc_html__( 'No more posts..', 'classic-elementor-addons-pro' );
			...
			$cursor_text_parts = [];
				...
				$cat_class = '';
				if( $blog_masonry && $isotope_filter && $filter_catoutput != '' ){
				...
				if( $extent_opt ) {
					...
					if( $elemetns ) {
						foreach( $elemetns['Enabled'] as $key => $content ) {
							echo $this->cea_blog_shortcode_elements( $key, $blog_array, $settings);
						}
					}
				...
				echo '<div class="'. esc_attr( $col_class . $cat_class ) . ($enable_mouse_hover ? ' cursor-hover-content' : '') .'" ' .  $cursor_attr .'>';
